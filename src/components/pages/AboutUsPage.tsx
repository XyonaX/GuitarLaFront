    ...
    <div className="container mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen lg:h-[600px]">
        ...
        <div className="flex flex-col justify-between bg-orange-600 py-12 px-6 sm:px-8 lg:px-16 h-full overflow-y-auto">
          ...
          {/* Llamada a la acción */}
          <div className="flex flex-col lg:flex-row justify-between items-center mt-auto space-y-2 lg:space-y-0 lg:space-x-4">
            <Link to="/about_us" className="w-full lg:w-auto">
              <button
                type="button"
